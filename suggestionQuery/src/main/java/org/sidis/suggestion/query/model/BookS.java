...
public class BookS {
    ...
    public BookS(final String isbn, final String title, final GenreS genre, final String description, final List<AuthorS> author) {
        this.isbn = isbn;
        this.title = title;
        this.genre = genre;
    ...
    public void setGenre(final GenreS genre) {
    ...
    public void applyPatch(long desiredVersion, String title, GenreS genre, String description) {
