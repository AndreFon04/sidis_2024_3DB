...
import org.sidis.suggestion.query.dto.AuthorDTO;
import org.sidis.suggestion.query.dto.BookDTO;
import org.sidis.suggestion.query.dto.ReaderDTO;
import org.sidis.suggestion.query.dto.SuggestionDTO;
import org.sidis.suggestion.query.model.*;
import org.sidis.suggestion.query.repositories.*;
    ...
    public void notifyBook(BookDTO bookDTO, @Header(AmqpHeaders.RECEIVED_ROUTING_KEY) String event) {
        ...
        switch (event) {
            case "book.created", "book.updated":
                ...
                System.out.println("Received book with isbn: " + bookDTO.getIsbn());
                if(bookRepository.findByIsbn(bookDTO.getIsbn()).isEmpty()) {
                    ...
                    l.add(new AuthorS("Fulano", "bio"));
                    BookS b1 = new BookS("abcde", "xx", new GenreS("abcd"), "xx", l);
                    b1.setBookID(2000);
