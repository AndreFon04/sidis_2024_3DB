...
package org.sidis.auth.configuration;
...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests()
				...
				.requestMatchers(HttpMethod.GET, "/api/readers/**").hasRole(Role.LIBRARIAN) // read-only for librarians
				...
				.requestMatchers(HttpMethod.PATCH, "/api/readers/**").hasRole(Role.READER) // edit-only readers
				...
				.requestMatchers(HttpMethod.PATCH, "/api/lendings/**").hasRole(Role.LIBRARIAN) // read-only lendings

				// Our private endpoints
				.requestMatchers("/api/admin/librarian/**").hasRole(Role.LIBRARIAN) // lib management
				.requestMatchers("/api/admin/reader/**").hasRole(Role.READER) // reader management
