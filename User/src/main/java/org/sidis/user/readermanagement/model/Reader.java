package org.sidis.user.readermanagement.model;
...
public class Reader {
	...
	@ElementCollection
	private final Set<Genre> interests = new HashSet<>();
...
//		this.createdBy = this.modifiedBy = "xxx";
    ...
    public Long getVersion() {return version;}  // for generating the etag

	public void applyPatch(final long desiredVersion, final String name, final String password, final String email,
						   final String birthdate, final String phoneNumber, final boolean GDPR, final Set<Genre> interests) {
	...
	public void addInterests(final Set<Genre> i) {
		interests.addAll(i);
	}

	public void setInterests(final Set<Genre> i) {
		interests.clear();
		interests.addAll(i);
	}
