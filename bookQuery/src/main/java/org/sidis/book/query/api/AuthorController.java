...
import org.sidis.book.query.api.AuthorViewMapper;
import org.sidis.book.query.api.BookViewMapper;
import org.sidis.book.query.api.Helper;
...
public class AuthorController {
    ...
    @Autowired
    public AuthorController(AuthorServiceImpl authorService, Helper helper, AuthorViewMapper authorViewMapper) {
        this.authorService = authorService;
        this.authorViewMapper = authorViewMapper;
//        this.coAuthorDTO = coAuthorDTO;
        this.helper = helper;
    }
