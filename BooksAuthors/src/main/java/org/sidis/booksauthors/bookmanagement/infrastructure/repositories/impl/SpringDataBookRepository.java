package org.sidis.booksauthors.bookmanagement.infrastructure.repositories.impl;
...
public interface SpringDataBookRepository extends BookRepository, CrudRepository<Book, Long> {
	...
	@Query("SELECT l.book FROM Lending l GROUP BY l.book ORDER BY COUNT(l.book) DESC LIMIT 5")
	List<Book> findTop5Books();
