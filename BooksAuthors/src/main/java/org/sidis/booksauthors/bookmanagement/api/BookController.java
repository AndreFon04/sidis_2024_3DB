package org.sidis.booksauthors.bookmanagement.api;
...
import com.example.library.bookmanagement.model.GenreBookCountDTO;
...
import com.example.library.bookmanagement.services.CreateBookRequest;
import com.example.library.bookmanagement.services.EditBookRequest;
...
class BookController {
	...
	@Operation(summary = "Gets the Top 5 Books")
	@GetMapping(value = "/top5Books")
	public List<BookView> findTop5Books() {
		return bookMapper.toBookView(bookService.getTop5Books());
	}
