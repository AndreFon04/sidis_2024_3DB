package org.sidis.suggestion.command.configuration;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .requestMatchers(HttpMethod.GET, "/api/suggestions/**").permitAll() // read-only lendings
                ...
                .requestMatchers(HttpMethod.POST, "/api/suggestions/**").permitAll() // read-only lendings
