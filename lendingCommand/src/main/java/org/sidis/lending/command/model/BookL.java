...
public class BookL {
    ...
    public BookL(final String isbn, final String title, final GenreL genre, final String description, final List<AuthorL> author) {
        this.isbn = isbn;
        this.title = title;
        this.genre = genre;
    ...
    public GenreL getGenre() {
        return genre;
    }

    public void setGenre(final GenreL genre) {
    ...
    public List<AuthorL> getAuthor() {
        return author;
    }

    public void setAuthor(List<AuthorL> author) {
        this.author = author;
    }
    ...
    public void applyPatch(long desiredVersion, String title, GenreL genre, String description) {
